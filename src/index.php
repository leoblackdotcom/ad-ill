            ...
            <div class="wn-grid adobe-article-grid">
              <div class="adobe-article-grid__header">
                ...
                <div class="adobe-article-grid__filters">
                  <label class="adobe-article-grid__filter"><span>I am</span><select class="adobe-select"><option value="experienced">Experienced</option><option selected="" value="beginner">A Beginner</option></select></label>
                  <label class="adobe-article-grid__filter"><span>and I want to</span>
                    <select class="adobe-select">
                      <!-- Experienced -->                      
